    ...
    <div id="sidebar">
        <div id="sidebar-wrapper">
            ...
            <div id="profile-links"> Hello, <a href="#" title="Edit your profile">865171</a>, you have <a href="#messages" rel="modal" title="3 Messages">3 Messages</a><br />
                <br />
                <a href="#" title="View the Site">View the Site</a> <?php echo $_SESSION['username'];?> <a href="http://localhost/learn_php/logout.php" title="Sign Out">退出</a> </div>
            <ul id="main-nav">
                <!-- Accordion Menu -->
        ...
        <div class="content-box">
            ...
            <div class="content-box-content">
                <div class="tab-content default-tab" id="tab1">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td>
                                <!-- Icons -->
                                <a href="http://localhost/learn_php的副本/update.php?userID=<?php echo $value[0] ?>" title="Edit"><img src="resources/images/icons/pencil.png" alt="Edit" />
                                </a>
                                <a href="http://localhost/learn_php的副本/delete.php?userID=<?php echo $value[0] ?>" title="Delete"><img src="resources/images/icons/cross.png" alt="Delete" />
                                </a>
                            </td>
                        </tr>
                ...
                <div class="tab-content" id="tab2">
                    <form action="http://localhost/learn_php的副本/add.php" method="post">
                        <fieldset>
                            ...
                            <p>
                                <label>性别</label>
                                <input class="text-input small-input" type="text" id="small-input" name="gender" />
                                <small>请输入性别</small> </p>
                            <p>
                            <p>
                                <label>手机号</label>
