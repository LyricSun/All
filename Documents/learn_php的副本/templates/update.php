        ...
        <div class="content-box">
            ...
            <div class="content-box-content">
                ...
                <div class="tab-content default-tab" id="tab2">
                    <form action="http://localhost/learn_php的副本/update.php" method="post">
                        <fieldset>
                            <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
                            <p>
                                <label>姓名</label>
                                <input class="text-input small-input" type="text" id="small-input" name="username" value="<?php echo $data[1];?>"/>
                                <small>请输入新的姓名</small> </p>
                            <p>
                                <label>性别</label>
                                <input class="text-input small-input" type="text" id="small-input" name="gender" value="<?php echo $data[2]?>"/>
                                <small>请输入新的性别</small> </p>
                            <p>
                            <p>
                                <label>手机号</label>
                                <input class="text-input small-input" type="text" id="small-input" name="phone" value="<?php echo $data[3]?>"/>
                                <small>请输入新的手机号</small> </p>
                                <input class="text-input small-input" type="hidden" id="small-input" name="userID" value="<?php echo $data[0];?>"/>
                            <p>
