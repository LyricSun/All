    ...
    <div id="sidebar">
        <div id="sidebar-wrapper">
            ...
            <div id="profile-links"> Hello, <a href="#" title="Edit your profile">865171</a>, you have <a href="#messages" rel="modal" title="3 Messages">3 Messages</a><br />
                <br />
                <a href="#" title="View the Site">View the Site</a> | <a href="#" title="Sign Out">退出</a> </div>
            <ul id="main-nav">
                <!-- Accordion Menu -->
        ...
        <div class="content-box">
            ...
            <div class="content-box-content">
                ...
                <div class="tab-content default-tab" id="tab2">
                    <form action="http://localhost/PHP_MySQL/php_07_PHP/update.php" method="post">
                        <fieldset>
                            <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
                            <p>
                                <label>姓名</label>
                                <input class="text-input small-input" type="text" id="small-input" name="username" value="<?php echo $upd_data[0]['username'];?>"/>
                                <small>请输入新的姓名</small> </p>
                            <p>
                                <label>性别</label>
                                <input class="text-input small-input" type="text" id="small-input" name="gender" value="<?php echo $upd_data[0]['gender'];?>"/>
                                <small>请输入新的性别</small> </p>
                            <p>
                            <p>
                                <label>手机号</label>
                                <input class="text-input small-input" type="text" id="small-input" name="phone" value="<?php echo $upd_data[0]['phoneNumber'];?>"/>
                                <small>请输入新的手机号</small> </p>
                                <input class="text-input small-input" type="hidden" id="small-input" name="userID" value="<?php echo $upd_data[0]['userID'];?>"/>
                            <p>
