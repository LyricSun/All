...
@section('content')
        <div class="col-sm-8">
            <blockquote>
                ...
                @include('user.badges.like',['target_user' => $user,'type' => 'top'])
            </blockquote>
        </div>
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane" id="tab_2">
                        ...
                        <div class="blog-post" style="margin-top: 30px">
                            ...
                            @include('user.badges.like',['target_user' => $suser,'type' => 'bottom'])
                    ...
                    <div class="tab-pane" id="tab_3">
                        @foreach($fusers as $fuser)
                            <div class="blog-post" style="margin-top: 30px">
                                ...
                                @include('user.badges.like',['target_user' => $fuser,'type' => 'bottom'])
