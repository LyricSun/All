    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-6">
                ...
                <form class="form-horizontal" id="cms-form" name="edit">
                    <div class="form-group">
                        <label for="inputname" class="col-sm-2 control-label">菜单名:</label>
                        <div class="col-sm-5">
                            <input type="text" name="name" class="form-control" id="inputname" placeholder="请填写菜单名" value="<?php echo ($edit["name"]); ?>">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label for="inputPassword1" class="col-sm-2 control-label">模块名:</label>
                        <div class="col-sm-5">
                            <input type="text" class="form-control" name="m" id="inputPassword1" placeholder="模块名如admin" value="<?php echo ($edit["m"]); ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="inputPassword2" class="col-sm-2 control-label">控制器:</label>
                        <div class="col-sm-5">
                            <input type="text" class="form-control" name="c" id="inputPassword2" placeholder="控制器如index" value="<?php echo ($edit["c"]); ?>">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="inputPassword3" class="col-sm-2 control-label">方法:</label>
                        <div class="col-sm-5">
                            <input type="text" class="form-control" name="f" id="inputPassword3" placeholder="方法名如index" value="<?php echo ($edit["f"]); ?>">
                        </div>
                    </div>
                    <!--<div class="form-group">
                    ...
                    <input type="hidden" name="menu_id" value="<?php echo ($edit["menu_id"]); ?>"/>
                <div class="form-group">
                    <div class="col-sm-offset-2 col-sm-10">
                        <button type="button" class="btn btn-default" id="cms-button-submit">更新</button>
                    </div>
                </div>
                </form>
...
<script>
    ...
    var SCOPE = {
        'save_url' : '/admin.php?c=menu&a=update',
